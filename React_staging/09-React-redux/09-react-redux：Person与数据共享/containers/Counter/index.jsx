...
import './index.css'
import {NORMALADD,NORMALSUBTRACT,ASYNCADD} from '../../redux/constant.js'

//引入connect用于连接UI组件与redux
import {connect} from 'react-redux'
////引入action
import {createNormalAdd,createNormalSubtract,createAsyncAdd} from '../../redux/actions/counter.js'
    ...
    render() {
        ...
        return (
            <div>
                ...
                <h2>总人数是{this.props.personList.length}</h2>
...
export default connect(state=>({count:state.count,personList:state.personList}),{
